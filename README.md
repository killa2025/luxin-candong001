...
代码 Patch 026～030 及各自复审修正均已并入 `main`；Patch 030 已通过第二十八次纯黑盒验收。Patch 031 只接入用户确认的长班、加班、三次固定增员与第七霜落开始事件正文，不修改事件触发、选项、人口、资源、信任、恐慌或其他机制与平衡。旧城实际离开或资源损失不符合现有正文时只登记 PENDING；`sedation_city` 正式触发公式尚未封存，其正文暂不进入运行选择。
